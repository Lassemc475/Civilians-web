<?php $title = "CN | Whitelist-modtager ansøgning";
            ...
            if ($user != false) {
                ...
                if ($discord) {
                    ...
                    if ($localip == $user['last_login']) {
                        ...
                        $notify->username = "CiviliansNetwork - Whitelist";
                        $notify->content = "Der er kommet en ny Whitelist-modtager ansøgning!";
...
<section id="contact2">
    ...
    <form action="" method="post">
        <h1>Whitelist-modtager ansøgning</h1>
